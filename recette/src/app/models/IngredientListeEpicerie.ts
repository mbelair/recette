...
export class IngredientListeEpicerie {
    ...
    getLabel(): string {
        ...
        if (this.recette) {
            return `${toReturn}${unitLabel} ${this.nom} <b>(${this.recette.nom})</b>`;
        } else {
            return `${toReturn}${unitLabel} ${this.nom}`;
        }
    }
    ...
    static fromIngredientRecette(i: IngredientRecette, r: Recette): IngredientListeEpicerie {
        const toReturn = new IngredientListeEpicerie();
        toReturn.ingredient_Id = i.ingredient_Id;
        toReturn.quantite = i.quantite;
        toReturn.unite = i.unite;
        toReturn.nom = i.ingredient.nom;
        toReturn.category = i.ingredient.category;
        toReturn.recette = r;
        return toReturn;
    }

    static fromIngredientListeEpicerie(i: IngredientListeEpicerie): IngredientListeEpicerie {
        const toReturn = new IngredientListeEpicerie();
        toReturn.ingredient_Id = i.ingredient_Id;
        toReturn.quantite = i.quantite;
        toReturn.unite = i.unite;
